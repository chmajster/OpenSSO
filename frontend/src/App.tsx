...
function columns(v:View){return ({users:["username","email","display_name","active","created_at"],groups:["name","description","created_at"],roles:["id","name","description"],applications:["name","client_id","public_client","require_pkce","created_at"],audit:["occurred_at","event","result","target_type","target_id","actor_user_id","ip"],dashboard:[]})[v]||[]}
